...
//     postData(`https://financialmodelingprep.com/api/v3/income-statement/TSLA?limit=120&apikey=8263508c794d9fc6c347f4670860b1a8`, { answer: 42 }).then((data) => {
...
async function postData(url = "", data = {}) {
  ...
  // 8263508c794d9fc6c347f4670860b1a8  NEW api key 
  // 57dbaca8774ef5359da35c985a6e5433
  postData(`https://financialmodelingprep.com/api/v3/income-statement/TSLA?limit=120&apikey=57dbaca8774ef5359da35c985a6e5433`, { answer: 42 }).then((data) => {
  console.log(data); // JSON data parsed by `data.json()` call
  data.forEach( function(element,index,array) {
  });
